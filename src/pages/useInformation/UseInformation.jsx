const UseInformation = () => {
  return (
    ...
    <>
      ...
      <div>
        <h2>Evaluar información relevante</h2>
        <p>
        ...
        <h3>Métodos para evaluar información relevante:</h3>
        <ul>
          <li>
            <strong> Profundidad y precisión del contenido:</strong> Verifica si
            la fuente trata el tema en profundidad y sin errores. Fuentes
      ...
      <div>
        ...
        <ul>
          ...
          <li>
            ...
            se pueden usar sin permiso. Utiliza recursos bajo licencias de libre
            uso, como Creative Commons, o con permisos de uso justo.
          </li>
        </ul>
        <iframe
          width="560"
      ...
      <div>
        <h2>Herramientas para organizar y citar fuentes</h2>
        <p>
          Aprender a organizar tus fuentes y citas facilita el trabajo y asegura
          que no olvides ningún crédito.
        </p>
        ...
        <ul>
          ...
          ></iframe>
          <li>
            <strong>Cite This For Me:</strong> Un generador de citas online que
            permite organizar y dar formato a las referencias de tus fuentes.
          </li>
          <iframe
            width="560"
            height="315"
      ...
      <div style={{ backGround: "red" }}>
        <h2>
          Práctica: Realiza una pequeña investigación y cita tus fuentes con
          Mendeley
        </h2>
        <p>Actividad práctica donde los estudiantes deben:</p>
        <ul>
          <li>
      ...
      <div>
        ...
        <a href="/productivityTools">-------next-------</a>
      </div>
    </>
  );
};
